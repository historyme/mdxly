...
Blockly.Arduino.MD_OLED_GeometryLine = function() {
  ...
  var x1wh = Blockly.Arduino.valueToCode(this, 'x1wh', Blockly.Arduino.ORDER_ATOMIC);
  ...
  if(type=='point') {
    ...
    code+='u8g.drawLine('+x0+','+y0+','+x1wh+','+y1h+');\n';
  } else if(type=='HLine') {
    code+='u8g.drawHLine('+x0+','+y0+','+x1wh+');\n';
  } else if(type=='VLine') {
    code+='u8g.drawVLine('+x0+','+y0+','+x1wh+');\n';
  } else if(type=='triangle') {
    code+='u8g.drawTriangle('+x0+','+y0+','+x1wh+','+y1h+','+x2r+','+y2+');\n';
  } else if(type=='frame') {
    code+='u8g.drawFrame('+x0+','+y0+','+x1wh+','+y1h+');\n';
  } else if(type=='RFrame') {
    code+='u8g.drawRFrame('+x0+','+y0+','+x1wh+','+y1h+','+x2r+');\n';
  } else if(type=='box') {
    code+='u8g.drawBox('+x0+','+y0+','+x1wh+','+y1h+');\n';
  } else if(type=='RBox') {
    code+='u8g.u8g.drawRBox('+x0+','+y0+','+x1wh+','+y1h+','+x2r+');\n';
  }
