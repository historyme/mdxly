...
//luokailiang
Blockly.LKL_DECLARE='Declare';
Blockly.LKL_AS='as';
Blockly.LKL_VALUE='value';
Blockly.LKL_VALUE2='value';
Blockly.LKL_MAP='Map ';
Blockly.LKL_MAP_FROM="from [";
...
Blockly.LKL_MODE='mode';
Blockly.LKL_DO='do';
Blockly.LKL_BUILDIN_LED='Build-in LED ';
Blockly.LKL_STAT='Stat';
Blockly.LKL_DIGITALWRITE_PIN='DigitalWrite PIN#';
...
Blockly.LKL_DURATION='duration';
Blockly.LKL_NOTONE_PIN='noTone PIN#';
...
Blockly.LKL_IR_SEND_RAW='IRsend(RAW) PIN#'
Blockly.LANG_MATH_TO_INT='toInt';
Blockly.LKL_SERVO='Servo';
Blockly.LKL_PIN='PIN#';
Blockly.LKL_DEGREE_0_180='Degree (0~180)';
Blockly.LKL_READ_DEGREES='Read Degrees';
Blockly.LKL_HIGH='HIGH';
Blockly.LKL_LOW='LOW';
Blockly.LKL_ON='ON';
Blockly.LKL_OFF='OFF';
Blockly.LKL_RISING='RISING';
Blockly.LKL_FALLING='FALLING';
Blockly.LKL_CHANGE='CHANGE';
Blockly.LKL_I2C_MASTER_WRITE="I2C_Write device";
Blockly.LKL_I2C_MASTER_READ="I2C_Read device";
Blockly.LKL_I2C_MASTER_READ2="I2C_Read";
Blockly.LKL_I2C_VALUE="value"
...
Blockly.LKL_DF_BUZZER='Buzzer';
Blockly.LKL_DF_BTN='Button';
Blockly.LKL_DF_VIBRATION='Vibration';
Blockly.LKL_DF_TILT='Tilt';
Blockly.LKL_DF_TOUCH='Touch';
Blockly.LKL_DF_MAGNETIC='Magnetic';
Blockly.LKL_DF_PYROELECTRIC_INFRARED='Pyroelectric infrared';
Blockly.LKL_MB_PYROELECTRIC_INFRARED='PIR Motion';
Blockly.LKL_DF_JOYSTICK_D='Joystick button';
Blockly.LKL_DF_JOYSTICK_A='Joystick';
Blockly.LKL_JOYSTICK='Joystick';
Blockly.LKL_DF_POTENTIOMETER='Potentiometer';
Blockly.LKL_POTENTIOMETER='Potentiometer';
Blockly.LKL_DF_ROTATION='Rotation';
Blockly.LKL_DF_VOLTAGE='Voltage';
Blockly.LKL_DF_PIEZO_DISK_VIRBRATION='Piezo disk virbration';
Blockly.LKL_DF_SOUND='Sound';
Blockly.LKL_SOUND='Sound';
Blockly.LKL_DF_RELAY='Relay';
Blockly.LKL_DF_LIGHT='Light';
Blockly.LKL_DF_GRAYSCALE='Grayscale';
Blockly.LKL_DF_FLAME='Flame';
Blockly.LKL_DF_TEMPERATURE='Temperature';
Blockly.LKL_TEMPERATURE='Temperature(℃)';
Blockly.LKL_DF_ACCELEROMETER='Accelerometer';
Blockly.LKL_DF_MOISTURE='Moisture';
Blockly.LKL_DF_WATER='Water';
Blockly.LKL_DF_CO='Carbon monoxide';
Blockly.LKL_DF_SHARP_GP2Y0A21='Sharp GP2Y0A21';
Blockly.LKL_MAKELISTFROM='make list from text';
Blockly.LKL_SPLITBYDOU='';
Blockly.LKL_SETUP='setup';
Blockly.LKL_WARNING_INTERRUPT='This pin cannot be interrupted!';
Blockly.LKL_CHAOSHENGBO='Ultrasonic ranging(cm) ';
Blockly.LKL_MB_CHAOSHENGBO='Ultrasonic ranging';
Blockly.LKL_IR_RECEIVE_YES='Received';
...
Blockly.LKL_IR_SEND_RAW_TOOLTIP='Sends RAW Infrared signals (set pin number, list, length of list and IR frequency)';
Blockly.LKL_LIST_NAME='list';
Blockly.LKL_LIST_LENGTH='listLength';
Blockly.LKL_TO_INT='toInt';
Blockly.LKL_TO_FLOAT='toFloat';
Blockly.LKL_DATA="data";
Blockly.LKL_BITS="bits";
Blockly.LKL_MB_LIGHT_GRAYSCALE='Light and Grayscale Sensor';
Blockly.LKL_MB_LIGHT_GRAYSCALE_LED=' LED set';
Blockly.LKL_MB_LIGHT_MOTOR='Set Motor';
Blockly.LKL_MB_LIGHT_MOTOR_SPEED=' Speed(-255~255)';
Blockly.LKL_DELAY_MS='ms';
Blockly.LKL_DELAY_US='μs';
Blockly.LKL_DHT11='DHT11 PIN#';
Blockly.LKL_DHT11_T='getTemperature';
Blockly.LKL_DHT11_H='getHumidity';
Blockly.LKL_LCD_RGB_BACKLIGHT='LCD RGB Backlight';
Blockly.LKL_DF_LCD='LCD';
Blockly.LKL_LCD_PRINT1='print line1';
Blockly.LKL_LCD_PRINT2='print line2';
Blockly.LKL_LCD_ROW='row';
Blockly.LKL_LCD_COLUMN='column';
Blockly.LKL_LCD_PRINT='print';
Blockly.LKL_LCD_SETCOLOR='setColor';
...
Blockly.LKL_LCD_STAT_CLEAR='Clear';
Blockly.LKL_7S_DISPLAY='7 Segment Display';
Blockly.LKL_NUMBER='number';
Blockly.LKL_BLUETOOTH='Bluetooth';
Blockly.LKL_BLUETOOTH_READ_STR='readString';
Blockly.LKL_AVAILABLE='available?';
Blockly.LKL_DATAPIN='dataPin#';
Blockly.LKL_CLOCKPIN='clockPin#';
Blockly.LKL_BITORDER='bitOrder';
Blockly.LKL_MSBFIRST='MSBFIRST';
Blockly.LKL_LSBFIRST='LSBFIRST';
Blockly.LKL_TOSTRING='toString';
Blockly.LKL_ROMEO_MOTOR='Romeo motor';
Blockly.LKL_ROMEO_MOTOR_SPEED='speed';
Blockly.LKL_STOP='stop';
Blockly.LKL_PULSEIN='pulseIn(μs) PIN#';
Blockly.LKL_PULSEIN_STAT='state';
Blockly.LKL_PULSEIN_TIMEOUT='timeout(μs)';
Blockly.LKL_SERIAL_READ_INT='parseInt';
Blockly.LKL_SERIAL_READ_FLOAT='parseFloat';
Blockly.LKL_MAX='max';
Blockly.LKL_MIN='min';
Blockly.LKL_WRITE_SD_FILE='Write SD File';
Blockly.LKL_SD_DATA='Data';
Blockly.LKL_SD_NEWLINE='NewLine';
Blockly.LKL_EEPROM_WRITE_LONG='Write EEPROM address';
Blockly.LKL_EEPROM_READ_LONG='Read EEPROM address';
Blockly.LKL_SENSE_MOTOR='Set Motor Speed(-255~255)';
Blockly.LKL_SENSE_MOTOR_STOP='Stop Motor';
Blockly.LKL_SENSE_SERVO='Set Servo Angle';
Blockly.LKL_SENSE_RGBLED='Set RGB LED\'s Color ';
Blockly.LKL_TRAFFIC_LED='Set Traffic LED';
Blockly.LKL_EAST='EAST';
Blockly.LKL_SOUTH='SOUTH';
Blockly.LKL_WEST='WEST';
Blockly.LKL_NORTH='NORTH';
Blockly.LKL_SENSE_BUZZER='Set Buzzer';
Blockly.LKL_SENSE_ULTRASONIC='Ultrasonic Value';
Blockly.LKL_SENSE_PYROELECTRIC_INFRARED='PIR Motion?';
Blockly.LKL_BUTTON='Button';
Blockly.LKL_UP='UP';
Blockly.LKL_DOWN='DOWN';
Blockly.LKL_LEFT='LEFT';
Blockly.LKL_RIGHT='RIGHT';
Blockly.LKL_MID='MID';
Blockly.LKL_IS_PRESSED='is pressed?';
Blockly.LKL_SENSE_SLIDING='Sliding Potentiometer Value';
Blockly.LKL_SENSE_TEMPERATURE='Temperature Value';
Blockly.LKL_SENSE_HUMIDITY='Humidity Value';
Blockly.LKL_SENSE_SOUND='Sound Value';
Blockly.LKL_SENSE_LIGHT='Light Value';
Blockly.LKL_SENSE_WEIGHT='Weight Value';
Blockly.LKL_SENSE_IR='IR Received:';
Blockly.LKL_SENSE_DIGITAL_DISPLAY='Set LED Digital Display(0~99)';
Blockly.LKL_SENSE_DIGITAL_DISPLAY_CLOSE='Close LED Digital Display';
Blockly.LKL_SENSE_LED_MATRIX='Set LED Matrix(0~9)';
Blockly.LKL_SENSE_LED_MATRIX_CLOSE='Close LED Matrix';
...
Blockly.LKL_MBOT_SPEED='at speed(-255~255)';
Blockly.LKL_RUNTIME='System running time';
Blockly.LKL_LED_ON_BOARD='led on board';
Blockly.LKL_ALL='all';
Blockly.LKL_SET_LED='Set LED';
Blockly.LKL_MBOT_TONE='Play tone';
Blockly.LKL_MBOT_NOTONE='Stop tone';
Blockly.LKL_SHOW_FACE='Show face';
Blockly.LKL_SHOW_FACE_TEXT='characters:';
Blockly.LKL_SHOW_FACE_TIME='time';
Blockly.LKL_MBOT_SET_DISPLAY='Set 7-segments display';
Blockly.LKL_MBOT_SET_LIGHT='Set light sensor';
Blockly.LKL_MBOT_SET_LIGHT_LED='led as';
Blockly.LKL_MBOT_SET_CAMERA='Set camera shutter';
Blockly.LKL_MBOT_SET_CAMERA_STAT='as';
Blockly.LKL_MBOT_SET_CAMERA_PRESS='Press';
Blockly.LKL_MBOT_SET_CAMERA_RELEASE='Release';
Blockly.LKL_MBOT_SET_CAMERA_FOCUS_ON='Focus On';
Blockly.LKL_MBOT_SET_CAMERA_FOCUS_OFF='Focus Off';
Blockly.LKL_MBOT_LIGHT_SENSOR='Light sensor';
Blockly.LKL_LIGHT_SENSOR_ON_BOARD='light sensor on board';
Blockly.LKL_MBOT_BUTTON='Button';
Blockly.LKL_MBOT_BUTTON_PRESSED='pressed';
Blockly.LKL_MBOT_BUTTON_RELEASED='released';
Blockly.LKL_MBOT_LINE_FOLLOWER='Line follower';
Blockly.LKL_MBOT_JOYSTICK='Joystick';
Blockly.LKL_MBOT_JOYSTICK_X='X-Axis';
Blockly.LKL_MBOT_JOYSTICK_Y='Y-Axis';
Blockly.LKL_MBOT_POTENTIOMETER='Potentiometer';
Blockly.LKL_MBOT_SOUND_SENSOR='Sound sensor';
Blockly.LKL_MBOT_LIMIT_SWITCH='Limit switch';
Blockly.LKL_MBOT_TEMPERATURE='Temperature';
Blockly.LKL_MBOT_PIR_MOTION_SENSOR='Pir motion sensor';
Blockly.LKL_MBOT_IR_REMOTE='Ir remote';
Blockly.LKL_MBOT_IR_REMOTE_PRESSED='pressed';
Blockly.LKL_SETTING='setting';
Blockly.LKL_SEND_MBOT_MESSAGE='Send mBot\'s message';
Blockly.LKL_MBOT_MESSAGE_RECEIVED='mBot\'s message received';
Blockly.LKL_LABPLUS_ROBOT_MOVEMENT='Robot movement';
Blockly.LKL_LABPLUS_ROBOT_MOVEMENT_GO_FORWARD='go forward';
Blockly.LKL_LABPLUS_ROBOT_MOVEMENT_STOP='stop';
Blockly.LKL_LABPLUS_ROBOT_MOVEMENT_GO_BACK='go back';
Blockly.LKL_LABPLUS_ROBOT='Robot';
Blockly.LKL_LABPLUS_ROBOT_TURN_LEFT='turn left';
Blockly.LKL_LABPLUS_ROBOT_TURN_RIGHT='turn right';
Blockly.LKL_LABPLUS_ROBOT_DISPLAY='Set led matrix to';
Blockly.LKL_LABPLUS_ROBOT_DISPLAY_SMILE='smile';
Blockly.LKL_LABPLUS_ROBOT_DISPLAY_NOSMILE='sad';
Blockly.LKL_LABPLUS_ROBOT_DISPLAY_CLOSE_EYE='close eyes';
Blockly.LKL_LABPLUS_ROBOT_DISPLAY_LEFT='left arrow';
Blockly.LKL_LABPLUS_ROBOT_DISPLAY_RIGHT='right arrow';
Blockly.LKL_LABPLUS_ROBOT_DISPLAY_TIAOWEN='stripe';
Blockly.LKL_LABPLUS_ROBOT_DISPLAY_ZEBRA='zebra';
Blockly.LKL_LABPLUS_ROBOT_DISPLAY_NOTHING='nothing';
Blockly.LKL_LABPLUS_ROBOT_LED_TOP='Set led on top to';
Blockly.LKL_LABPLUS_ROBOT_LED_SIDE='Set side leds\' color to';
Blockly.LKL_LCD_ADDRESS="LCD address";
var MSG = {
  catInOut: "In/Out",
  catControl: "Control",
  catMath: "Math",
...
Blockly.LKL_TOOLTIP_INOUT_HIGHLOW='Returns high or low voltage.';
Blockly.LKL_TOOLTIP_INOUT_DIGITAL_READ='Returns digital value of a specific Port';
Blockly.LKL_TOOLTIP_INOUT_ANALOG_WRITE='Writes analog value between 0 and 255 to a specific Port';
Blockly.LKL_TOOLTIP_INOUT_ANALOG_READ='Returns value between 0 and 1024 of a specific Port';
Blockly.LKL_TOOLTIP_INOUT_ATTACHINTERRUPT='Attachs interrupt to a specific Port';
Blockly.LKL_TOOLTIP_INOUT_DETACHINTERRUPT='Detachs interrupt to a specific Port';
Blockly.LKL_TOOLTIP_CONTROL_SETUP='Initialization(run only once)';
Blockly.LKL_TOOLTIP_CONTROL_DELAY='Delays specific time';
Blockly.LKL_TOOLTIP_CONTROL_MILLIS='Returns the system running time';
Blockly.LKL_TOOLTIP_VARIABLES_DECLARE='Declare and initialize a variable';
Blockly.LKL_TOOLTIP_MATH_MAX='Returns the larger number';
Blockly.LKL_TOOLTIP_MATH_MIN='Returns the smaller number';
Blockly.LKL_TOOLTIP_MATH_MAP='Maps a number from the first interval to the second interval.';
Blockly.LKL_TOOLTIP_TEXT_JOIN='Creates a piece of text by joining together two piece of text.';
Blockly.LKL_TOOLTIP_TEXT_TOTEXT='Converts a number into a string.';
Blockly.LKL_TOOLTIP_TEXT_TOINT='Converts a string into an integer.';
Blockly.LKL_TOOLTIP_TEXT_TOFLOAT='Converts a string into an float.';
Blockly.LKL_TOOLTIP_LISTS_CREATE_WITH_TEXT = "Creates a list from a text.";
Blockly.LKL_TOOLTIP_LOGIT_TRUEORFALSE='If the first number is true, the second number is returned, otherwise the third number.';
Blockly.LKL_TOOLTIP_BLOCKGROUP_SERIAL_AVAILABLE='If the serial port is available, it returns true, otherwise returns false.';
Blockly.LKL_TOOLTIP_BLOCKGROUP_SERIAL_READ_STR='Returns a string in serial port.';
Blockly.LKL_TOOLTIP_BLOCKGROUP_SERIAL_READ_INT='Returns a integer in serial port.';
Blockly.LKL_TOOLTIP_BLOCKGROUP_SERIAL_READ_FLOAT='Returns a float in serial port.';
Blockly.LKL_TOOLTIP_BLOCKGROUP_CHAOSHENGBO='Returns the distance of ultrasonic sensor measured.';
Blockly.LKL_TOOLTIP_BLOCKGROUP_DHT11_TEM='Returns the temperature of dht11 sensor measured.';
Blockly.LKL_TOOLTIP_BLOCKGROUP_DHT11_HUM='Returns the humidity of dht11 sensor measured.';
Blockly.LKL_TOOLTIP_BLOCKGROUP_SERVO_MOVE = 'Moves between 0~180 degree.';
Blockly.LKL_TOOLTIP_BLOCKGROUP_SERVO_READ = 'Returns that degree with the last servo move.';
...
Blockly.ColorLEDInit='ColorLED prepare:';
...
Blockly.LEDBreathingTime='Time';
Blockly.BreathingLight='Breathing Light';
Blockly.BreathingLightH='Breathe Out';
Blockly.BreathingLightX='Breathe In';
Blockly.BuzzerMelody='Melody';
Blockly.ColorSet='Color:';
...
Blockly.Buzzer='Buzzer ON';
Blockly.BuzzerNoTone='Buzzer OFF';
Blockly.BuzzerNum='Buzzer Number';
...
Blockly.serialPrintln='Serial Println:';

Blockly.Zigbee='Zigbee';
Blockly.Zigbee_SetAT='For AT';
Blockly.Zigbee_Available='Available?';
Blockly.Zigbee_Read='Read(Return String)';
Blockly.Zigbee_Send='Send';
Blockly.VariableName='Variable';
Blockly.VariableIs='is?';
Blockly.Zigbee_Init='Zigbee Initialization';
Blockly.Zigbee_Baud='Baud Rate:';

Blockly.SD='SD Module';

Blockly.INT='int ';
Blockly.BOOLEAN='true/false(boolean)';


Blockly.DotMatrix='Dot Matrix:'
Blockly.DotMatrixName='Frame Name:'
Blockly.MatrixRow0='row 1:';
Blockly.MatrixRow1='row 2:';
Blockly.MatrixRow2='row 3:';
Blockly.MatrixRow3='row 4:';
Blockly.MatrixRow4='row 5:';
Blockly.MatrixRow5='row 6:';
Blockly.MatrixRow6='row 7:';
Blockly.MatrixRow7='row 8:';

Blockly.File_Name='File Name';
Blockly.Content='Content';
Blockly.SD_Read='Read SD Card';
Blockly.SD_Write='Write SD Card';


Blockly.W5500='W5500';
Blockly.W5500_Init='initializing';

Blockly.Struct='Structure';
Blockly.Struct_DEF='and Name';
Blockly.LKL_DECLARE_STRUCT='(In struct)Declare';
Blockly.STRUCT='struct';
Blockly.StructDef='Declare Struct';
...
Blockly.ms='ms';
Blockly.Send_INFO='Send this:';
Blockly.Read_INFO='Save As';
Blockly.GLOBAL_DECLARE='Declare Global';

Blockly.smartRF_Init_Read='smartRF Read Initialization';
Blockly.smartRF_Init_Send='smartRF Send Initialization';
Blockly.smartRF='smartRF';
Blockly.Frequency='Frequency:';
Blockly.SENDADDR='SendAddress:';
...
Blockly.NFC_Read='Read';


Blockly.GSM='GSM Module';
Blockly.GSM_SMS='send messages to';
...
Blockly.IRReciverEnable='IR Reciver Enable';
...
Blockly.Keyget_Or='or';
Blockly.Keyget_Analog='analog value from';
Blockly.Keyget_To='to';
Blockly.KeyInput='INPUT';
Blockly.KeyInputpullup='INPUT_PULLUP';
...
Blockly.WiFiSSID='SSID:';
Blockly.typeSSID='type your SSID';
Blockly.WiFiPass='Pass:';
Blockly.typePass='type your pass';
Blockly.HOST_NAME='HOST NAME:';
Blockly.HOST_PORT='HOST PORT:';
...
Blockly.tfCard='TF Card';
Blockly.flashMemory='Flash Memory';
Blockly.MODE_ONE='Mode One';
Blockly.MODE_ONE_STOP='Mode One Stop';
Blockly.MODE_ALL='Mode All';
Blockly.MODE_FOL='Mode Follow';
Blockly.MODE_RAM='Mode Random';

Blockly.AudioPlay='Play';
Blockly.AudioPause='Pause';
Blockly.AudioNext='Next';
Blockly.AudioPrev='Previous';
Blockly.AudioVolUp='Volume UP';
Blockly.AudioVolDown='Volume Down';


Blockly.SetRTCTime='Set Time';
Blockly.RTCYear='Year';
Blockly.RTCMouth='Mouth';
Blockly.RTCDay='Day';
Blockly.RTCWeek='Week';
...
Blockly.low1DO='low 1DO';
Blockly.low2RE='low 2RE';
Blockly.low3MI='low 3MI';
Blockly.low4FA='low 4FA';
Blockly.low5SO='low 5SO';
Blockly.low6LA='low 6LA';
Blockly.low7XI='low 7XI';
Blockly.midlle1DO='midlle 1DO';
Blockly.midlle2RE='midlle 2RE';
Blockly.midlle3MI='midlle 3MI';
Blockly.midlle4FA='midlle 4FA';
Blockly.midlle5SO='midlle 5SO';
Blockly.midlle6LA='midlle 6LA';
Blockly.midlle7XI='midlle 7XI';
Blockly.high1DO='high 1DO';
Blockly.high2RE='high 2RE';
Blockly.high3MI='high 3MI';
Blockly.high4FA='high 4FA';
Blockly.high5SO='high 5SO';
Blockly.high6LA='high 6LA';
Blockly.high7XI='high 7XI';
...
Blockly.interval='Interal Time';
Blockly.interalMILLIS='millis';

Blockly.BuzzerSong='Song';
Blockly.BuzzerSong1='kerchiefs';
Blockly.BuzzerSong2='Two Tiger';
Blockly.BuzzerSong3='Dingdang cat';
Blockly.BuzzerSong4='Happy birthday';
Blockly.BuzzerSong5='Find frind';
Blockly.BuzzerSong6='hulu brother';
Blockly.BuzzerSong7='on the board';
Blockly.BuzzerSong8='apple';
Blockly.BuzzerSong9='bird';
Blockly.BuzzerSong10='where is spring';

Blockly.DotMatrixAddress='DotMatrix Address';

Blockly.timeOutBegin='Time Out Begin';
Blockly.timeOutDoing='Time Out Doing';
Blockly.timeOutDuration='Time Out';


Blockly.AuthToken='Blynk Auth Token';
Blockly.TypeAuthToken='Type your Blynk Auth Token';
Blockly.BLYNK_READ='Send Data';
Blockly.virtualPort='Virtual Port';
Blockly.inputValue='Data';
Blockly.BLYNK_WRITE='Recive Data';
Blockly.SoloParam='Solo parameters';
Blockly.paramType='Parameters Type';
Blockly.BLYNKString='String';
Blockly.BLYNKInt='Integer';
Blockly.BLYNKDouble='Double';
Blockly.paramIndex='Parameters Index';
Blockly.ArrayParam='Array Parameters';
Blockly.BlynkTimer='Timer';

Blockly.dotMatrixAddVar='Address Name';
Blockly.dotMatrixAddVarArray='Dot Matrix address Array';

Blockly.halfRhythm='Half Rhythm';
